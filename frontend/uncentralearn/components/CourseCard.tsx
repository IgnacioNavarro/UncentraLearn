    ...
    return (
        <div className="flex flex-row bg-white h-96 justify-center items-center space-x-4" id="courses">
            <div className="flex flex-col border-solid border-2 border-black">
                ...
                <p className="text-2xl text-black justify-center py-2 px-4 pr-6 underline font-light">{props.courseAuthor}</p>
                <div className="flex flex-row space-x-2 px-4">
                    ...
                    <p className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">({props.courseRating})</p>
